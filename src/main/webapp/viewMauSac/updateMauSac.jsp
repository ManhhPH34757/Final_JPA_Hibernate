...
<div class="row mt-3">
    <div class="text-center">
        <h3 class="text-danger">Sửa màu sắc</h3>
    </div>
    <div class="col-3"></div>
    <div class="col-6">
        <form action="update-mauSac?id=${ms.id}" method="post">
            <div class="mt-3">
                ...
                <input class="form-control" name="maMau" id="ma" type="text" value="${ms.maMau}">
            </div>
            <div class="mt-3">
                <label for="name"><strong>Tên màu:</strong></label>
                <input class="form-control" name="tenMau" id="name" type="text" value="${ms.tenMau}">
            </div>
            <div class="mt-3">
